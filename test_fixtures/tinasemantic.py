...
sys.path.insert(0,'../scratchNLP/test_fixtures/')
import tinasemanticRules as lab_rules
sys.path.insert(0,'../scratchNLP/scripts/')
...
def parse_input_str(input_str):
    ...
    gv.add_unknowns_to_grammar(input_str, lab_rules.sem)
